...
// ── API JSON para los componentes React (POS Fase 4) ──────────────────────
Route::prefix('api')->middleware(['auth'])->group(function () {
    Route::get('/pos/areas',           [PosApiController::class, 'areas']);
    Route::get('/pos/order/{tableId}', [PosApiController::class, 'order']);
    Route::get('/pos/products',        [PosApiController::class, 'products']);
    Route::get('/pos/clients',         [PosApiController::class, 'clients']);
    Route::get('/kitchen/orders',      [KitchenController::class, 'ordersJson']);
});